...
public class ConfirmationPaypal2 extends AppCompatActivity {
    private  String session_name,shop_name,un,order_id,p_type,date_time,payment_ID ="",table;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confirmation_paypal2);
        Intent i = getIntent();
    ...
    private void proceed() {
        Intent myIntent = new Intent(ConfirmationPaypal2.this, restaurant_payment_receipt.class);
